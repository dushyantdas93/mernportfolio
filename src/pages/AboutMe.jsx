...
const AboutMe = () => {
  return (
    <div className=" w-full lg:w-4/6  mx-auto  flex  flex-col lg:px-6 justify-around gap-10 ">
      <h1 className="font-bold text-3xl lg:text-4xl py-2 lg:py-10 px-6 lg:px-0 flex relative">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-around w-full h-full gap-10">
        ...
        <div className="w-[90%] lg:w-[70%] border border-black flex flex-col lg:flex-row rounded-lg px-6 h-auto lg:gap-5">
          <div className="w-full lg:w-1/2 py-6 flex flex-col gap-5">
            ...
            <button className="bg-red-400 px-2 w-40 py-1 rounded-xl font-semibold lg:text-lg text-white">
              DownLoad CV
            </button>
          </div>
            ...
            {[1, 2, 1].map((item, idx) => {
              return (
                ...
                >
                  ...
                  <div className="w-full h-3 border border-black px-4 rounded-lg bg-blue-300"></div>
                </div>
              );
            })}
          </div>
