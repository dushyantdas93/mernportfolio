...
const Hireme = () => {
  return (
    <div className=" w-full  flex  flex-col justify-center lg:justify-around  items-center    py-10  h-full lg:h-auto">
      <div className=" w-full lg:w-1/3 flex flex-col items-center pt-16  gap-4 lg:gap-6 ">
        ...
        <div className="flex items-center justify-center w-1/2 gap-2 lg:gap-6 ">
          {[1, 2, 3, 4, 5].map((item) => {
            return <FaInstagram className="size-7 lg:size-9" />;
          })}
        </div>
